...
workflow, and Figure 6A is an anatomical target illustration. Those two display
layouts remain manual assembly steps; the analysis outputs underlying their
associated quantitative results are generated by the numbered workflow.
